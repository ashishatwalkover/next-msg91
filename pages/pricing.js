      ...
      <div className="container d-flex justify-content-center">
        <div className="text-center py-5">
          ...
          <div className="c-fs-3">
            <ul className="nav nav-pills mb-3 c-fs-5" id="pricing-pills-tab" role="tablist">
            ...
            <div className="tab-content d-flex justi" id="pills-tabContent">
              <div className="tab-pane fade show active" id="pills-sms" role="tabpanel" aria-labelledby="pills-sms-tab" tabIndex={0}>
                <form className="g-3 d-flex justify-content-center">
                ...
                <div className="text-center c-fs-3">Number of SMS</div>
                <div className="sms-range">
                  <input type="range" className="form-range" min="0" max="5" step="0.5" id="customRange1" />
                </div>
                ...
                <div className="d-flex align-items-center p-4 total-price col-lg-6 mx-auto">
                  <div className="c-fs-3">Total Price</div>
                  <div className="total c-fs-3 fw-bold">₹ 5,000</div>
                  <div>+18% GST</div>
