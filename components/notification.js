      ...
      <div className="px-1 px-md-5 c-bg-grey c-fs-4">
        <div className="px-0 px-xl-5 py-1">
          <div className="px-0 px-md-3 d-flex flex-md-row flex-column align-items-start   align-items-md-center  justify-content-md-between ">
            ...
            <div className=" text-dark d-flex justify-content-between col-12 col-sm-12 col-md-5 col-lg-3  ">
              ...
              <span className=" align-items-center d-none d-md-flex"><MdCall /><a href="/contact-us"  className="text-dark ms-1 d-none d-md-block">Contact Us</a></span>
              <span className=" align-items-center d-flex"><a href="https://control.msg91.com/signin/" target="_blank" className="text-dark">Log In</a></span>
            </div>
          </div>
        </div>
      </div>
