      ...
      <div className="d-flex flex-wrap flex-gap justify-content-center w-100  card-container align-items-end">
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">5,000 Calls</h3>
            <h5 className="c-fs-4 mt-2">₹0.25/Calls</h5>
        ...
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">20,000 Calls</h3>
            <h5 className="c-fs-4 mt-2">₹0.20/Calls</h5>
            <p className="c-fs-5"> - </p>
        ...
        <div className="  mx-3 text-center d-flex flex-column mb-4 mb-sm-0 align-items-center ">
          ...
          <div className="card  text-center card-popular border-primary mb-4 mb-sm-0 c-bg-grey">
            <div className="card-body">
              <h3 className="c-fs-3">50,000 Calls</h3>
              <h5 className="c-fs-4 mt-2">₹0.18/Calls</h5>
              <p className="c-fs-5"> - </p>
        ...
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">1,00,000 Calls</h3>
            <h5 className="c-fs-4 mt-2">₹.17/Calls</h5>
            <p className="c-fs-5"> - </p>
        ...
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">3,00,000 Calls</h3>
            <h5 className="c-fs-4 mt-2">₹.14/Calls</h5>
            <p className="c-fs-5"> - </p>
        ...
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">5,00,000 Calls</h3>
            <h5 className="c-fs-4 mt-2">₹.12/Calls</h5>
            <p className="c-fs-5"> - </p>
        ...
        <div className="card  border-0 text-center mb-4 mb-sm-0 c-bg-grey">
          <div className="card-body">
            <h3 className="c-fs-3">5,00,000+ Calls</h3>
            <h5 className="c-fs-4 mt-2">₹.10/Calls</h5>
            <p className="c-fs-5"> - </p>
