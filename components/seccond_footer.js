const SeccondFooter =()=>{
    return(
        ...
        <div className="container p-5 d-flex justify-content-sm-center align-items-center p-5">
            <div className=" c-bg-grey  p-5 container text-center d-flex justify-content-sm-between align-items-center flex-xl-row flex-lg-column flex-sm-column flex-md-column flex-column"> 
