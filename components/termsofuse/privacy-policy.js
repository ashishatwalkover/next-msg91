        ...
        <div className="col-12  terms-content">
          ...
          <div className="mb-5">
            ...
            <p className="c-fs-4">
              ...
              HELLO
              <div className="my-3"></div>
              By accepting the HELLO Application Privacy Policy and/or using the Services You consent to the collection, use, sharing and processing of information as described in this policy. You reserve the right to opt-out at any time to prevent further use of the information shared via the Services.
              <div className="my-3"></div>
              1. Use Of Personal Information
              <div className="my-3"></div>
              1.1 Information We May Need
              <div className="my-3"></div>
              HELLO Application may use the information collected to provide, maintain, improve, analyze and personalize the Services to its Users, partners and third-party providers. More specifically, HELLO Application may use permissions that will ask for user’s approval on runtime for specific actions such as:
              <div className="my-3"></div>
              Provide a popup caller ID, that allows for the population of contact information that may or may not be stored in our database or any third party database.
              Interact with the HELLO Google Chrome extension for the purpose of making direct cellular phone calls and SMS to other HELLO Application users.
