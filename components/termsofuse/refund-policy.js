        ...
        <>
            <div className="mb-5">
                ...
                We will refund your amount, but if someone tries to misuse, they’re legally bound.
                    ...
                    <div className="my-1"></div>
                    3. Closing the account by the user without using MSG91 services for a long time does not obligate MSG91 to refund the amount for the unused period.
                    <div className="my-1"></div>
            ...
            <div className="mb-5">
                ...
                <p className="c-fs-4">
                    ...
                    Services) made available to you (the client) by MSG91 through
                    https://msg91.com/india/ (MSG91).The use of services from
                    https://msg91.com/ (under Walkover Web Solutions Pvt. Ltd.)
