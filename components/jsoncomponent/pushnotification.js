      ...
      <div className="container text-center  overflow-hidden ">
        <div className=" mx-auto text-center justify-content-center py-2 py-md-5 col-12 col-sm-8">
          <div className="d-flex justify-content-center align-items-center flex-column flex-sm-row">
            <img src="../img/pushnotification.svg" className="product-page-logo" />
            <h1 className="heading">Pushnotification</h1>
          </div>

          <p className="c-fs-4 text-uppercase col-pushnotification c-ls-20 mx-auto">
            {data?.pushnotification?.smallheading}
          </p>
          <h2 className="small-heading px-3 w-md-75 w-100 mx-auto">
            {data?.pushnotification?.tagline}
          </h2>
          ...
          <TrustedSec />
        <img
          src={data?.pushnotification?.pageimg}
      ...
      <div className=" c-bg-grey  px-sm-0 d-flex flex-column justify-content-center justift-content-sm-start section ">
        ...
        <div className="container flex-column d-flex flex-md-row-reverse align-items-center justify-content-between mb-5">
          <div className="  col-12 col-md-7 d-flex">
            <img
              src={data?.pushnotification?.features?.one?.img}
              className="feature-img ms-auto"
            />
          </div>
          <div className="col-12 col-md-5 d-flex flex-column ">
            <span className="c-fs-2 c-fw-m ">
              {data?.pushnotification?.features?.one?.heading}
            </span>
            <span className="c-fs-3  mt-3">
              {data?.pushnotification?.features?.one?.content}
            </span>
          </div>
        </div>
        <div className="container flex-column d-flex flex-md-row align-items-center justify-content-between mb-5">
          <div className="  col-12 col-md-7 d-flex">
            <img
              src={data?.pushnotification?.features?.two?.img}
              className="feature-img ms-auto"
            />
          </div>
          <div className="col-12 col-md-5 d-flex flex-column ">
            <span className="c-fs-2 c-fw-m ">
              {data?.pushnotification?.features?.two?.heading}
            </span>
            <span className="c-fs-3  mt-3">
              {data?.pushnotification?.features?.two?.content}
            </span>
          </div>
        </div>
        <div className="container flex-column d-flex flex-md-row-reverse align-items-center justify-content-between mb-5">
          <div className="  col-12 col-md-7 d-flex">
            <img
              src={data?.pushnotification?.features?.three?.img}
              className="feature-img ms-auto"
            />
          </div>
          <div className="col-12 col-md-5 d-flex flex-column ">
            <span className="c-fs-2 c-fw-m ">
              {data?.pushnotification?.features?.three?.heading}
            </span>
            <span className="c-fs-3  mt-3">
              {data?.pushnotification?.features?.three?.content}
            </span>
          </div>
        </div>
      ...
      <div className="section mx-0 mx-md-5 mt-5 pt-4 pt-md-0">
        ...
        <div className="w-100 d-flex flex-column flex-md-row my-2">
          <div className="container d-flex flex-column justify-content-center align-items-flex-start col-lg-6 mt-2 px-3">
            <span className="c-fs-3">- {data?.pushnotification?.morefeatures?.one}</span>
            <span className="c-fs-3 mt-1">
              - {data?.pushnotification?.morefeatures?.two}
            </span>
            <span className="c-fs-3 mt-1">
              - {data?.pushnotification?.morefeatures?.three}
            </span>
            <span className="c-fs-3 mt-1">
              - {data?.pushnotification?.morefeatures?.four}
            </span>
            <span className="c-fs-3 mt-1">
              - {data?.pushnotification?.morefeatures?.five}
            </span>
            <span className="c-fs-3 mt-1">
              - {data?.pushnotification?.morefeatures?.six}
            </span>
          </div>
